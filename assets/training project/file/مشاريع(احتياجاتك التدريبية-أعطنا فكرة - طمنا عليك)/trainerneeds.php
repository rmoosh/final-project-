...
<img src="images/mins.png" alt="" width="250" height="80" class="image2"/>
            ...
            <section>				
                <div id="container_demo"  >
                    ...
                    <div id="wrapper" style="right: 0px; top: 0px" >
                            ...
                            <form name="trainerneedsform" id="trainerneedsform"   class="statform_trigger" method="post"  action="trainerneeds_ajax.php">
                                <h1> جاوب على الاسئلة التالية :</h1> 
...
//=============================================================
 ...
 include 'sqlopen_pdo.php';
    ...
    $stmt = $db->prepare("select * from trainerneeds ") ;
$stmt->execute(array()) ;
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC))
  {
	        ...
	        echo("<input type='hidden'  style='width: 746px; height: 26px' Name='QsnID[$i]' value='$QsnID' >"); 
	       echo("<input type='hidden'  style='width: 746px; height: 26px' Name='QsnName[$i]' value='$QsnName' >");
	        echo("</td>");
	        echo("</tr>");
	       //------------------------------
	        echo("<tr>");
	        echo("<td>");
	        echo("<p>");
	        echo("<input type='radio'  Name='Qtans[$i]' value='True' style='width: 24px' > نعم  ");
	        echo("<p>");
	        echo(" <input type='radio' Name='Qtans[$i]' value='False' style='width: 24px' > لا ");
	        echo("<p>");
	        echo("</td>");
	        echo("</tr>");
	        echo("</table>");
...
?>
                                ...
                                <p class="login button"> 
                                    <input type="submit" value="النتيجة" /> 
								</p>
